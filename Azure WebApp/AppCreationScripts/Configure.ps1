...
Function ConfigureApplications {
    ...
    Write-Host "Creating the AAD application (OrangeCorpEvents)"
    # create the application 
    $spaAadApplication = New-MgApplication -DisplayName "OrangeCorpEvents" `
    ...
    Write-Host "Done creating the spa application (OrangeCorpEvents)"
    ...
    Add-Content -Value "<tr><td>spa</td><td>$currentAppId</td><td><a href='$spaPortalUrl'>OrangeCorpEvents</a></td></tr>" -Path createdApps.html
